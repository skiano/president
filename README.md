...
If ```isMyTurn``` is ```true```, you must return your move. You can return one card, an array of cards, or, if you cannot make a valid move, return ```false```. See below for more information.
